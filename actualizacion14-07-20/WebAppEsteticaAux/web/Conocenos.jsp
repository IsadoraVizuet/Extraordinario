        ...
        <div class="container mt-2">
            ...
            <div class="row"> 
                <div class="col-sm-4"> 
                    <br><br>
                    <br><br>
                    <div><img src="img/conocenos_aux.jpg" width="100%" ></div>
                    <br><br>
                ...
                <div class="col-sm-8"> 
                    ...
                    <br><br>
                     <br><br>
                    <center>Somos estilistas apasionados por nuestra profesi&oacute;n, con 10 a&ntilde;os de experiencia.<br>
                        Nos mantenemos en constante actualizaci&oacute;n para brindarte las t&eacute;cnicas de vanguardia en el ramo , con productos de la m&aacute;s alta calidad.<br>
                        Estamos comprometidos con proporcionarte una experiencia inigualable, dentro de un protocolo de amabilidad e higiene para tu tranquilidad y seguridad.
                    </center> 
                    <br><br>
                </div>
            </div>
